...
class Menu_Screen(Screen):
    ...
    def MenuScreen_Checks(self):
        ...
        if (
                isfile(App.get_running_app().user_data_dir + "/game.dat") is True
                or self.manager.has_screen("gameScreen") is True
        ):
        ...
        if self.parent.has_screen("gameScreen") is True:
            ...
            try:
                ...
                try:
                    ...
                    self.ids[
                        "t2lab"
                    ].text = "Unable to continue from previous game - sorry"
        else:
    ...
    def Are_You_Sure(self):
        ...
        box = BoxLayout(
            ...
            size_hint_x=None,
            size=(menuScroller.width, menuScroller.height),
        )
        ...
        box.add_widget(lab)
        if (
                self.parent.has_screen("gameScreen") is True
                or isfile(App.get_running_app().user_data_dir + "/game.dat") is True
        ):
